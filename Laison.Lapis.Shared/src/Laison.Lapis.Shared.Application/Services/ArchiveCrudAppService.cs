...
namespace Laison.Lapis.Application.Shared
{
    ...
    /// Crud应用服务
    /// </summary>
    public abstract class ArchiveCrudAppService<TEntity, TEntityDto, TKey, TGetListInput> : ArchiveCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TEntityDto, TEntityDto>
