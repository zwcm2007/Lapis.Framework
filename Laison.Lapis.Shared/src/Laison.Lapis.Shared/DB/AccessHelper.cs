...
namespace Laison.Lapis.Shared.DB
{
    public static class AccessHelper
    {
        //数据库连接字符串
        //public static readonly string conn = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\mydatabase.mdb;User Id=admin;Password=;";
        ...
        /// <returns></returns>
        public static void ExecuteTransaction(string connectionString, Action<OleDbCommand> action)
        {
            using (var connection = new OleDbConnection())
            {
                ...
                using (var trans = connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        PrepareCommand(cmd, connection, trans, null, null);
