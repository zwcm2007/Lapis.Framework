...
namespace DangKe.Extensions
{
    ...
    public static class ArrayExtensions
    {
        ...
        #endregion IsNullOrEmpty(判断数组是否为空)
        ...
        #endregion FindArrayInArray(在byte[]数组中查找指定byte[]数组)
        ...
        #endregion ToString(字符串数组转换为字符串)
