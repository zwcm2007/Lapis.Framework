...
namespace DangKe.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        #endregion IsNullableType(判断类型是否为Nullable类型)
        ...
        #endregion GetNonNummableType(由类型的Nullable类型返回实际类型)
        ...
        #endregion GetUnNullableType(获取Nullable类型的基础类型)

        #region GetDescription(获取类型的Description特性描述信息)
        ...
        #endregion GetDescription(获取类型的Description特性描述信息)
        ...
        #endregion HasAttribute(检查指定类型成员中是否存在指定的Attribute特性)
        ...
        #endregion GetAttribute(从类型成员获取指定Attribute特性)
        ...
        #endregion IsEnumerable(判断类型是否为集合类型)
        ...
        #endregion IsBaseOn(当前类型是否是指定基类的派生类)
        ...
        #endregion IsBaseType(判断当前类型是是否基类型)
        ...
        #endregion IsSubclassOfRawGeneric(判断当前类型是否子类的泛型类型)
        ...
        #endregion CreateGenericTypeInstance(创建泛型类型实例)
    }
}