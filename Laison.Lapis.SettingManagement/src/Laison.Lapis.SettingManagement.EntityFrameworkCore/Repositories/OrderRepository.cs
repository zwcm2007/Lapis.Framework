...
namespace Laison.Lapis.SettingManagement.EntityFrameworkCore
{
    ...
    /// Order Repository
    /// </summary>
    public class OrderRepository : EfCoreRepository<ISettingManagementDbContext, Order, Guid>, IOrderRepository
    {
        /// <summary>
        /// Ctor
        /// </summary>
        /// <param name="dbContextProvider"></param>
        public OrderRepository(IDbContextProvider<ISettingManagementDbContext> dbContextProvider)
